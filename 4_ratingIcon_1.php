...
<html>
	...
	<form method="post" action="4_rest_1.php">
		<?php
			...
			// ****** info to change manually ******
			// record link: https://docs.google.com/spreadsheets/d/1_Dz0uN0XP1z9k-pwk2yFas60CS6Cl3vhrUur0QAaTys/edit#gid=0
			$function_batch_num = 0; //change from 0, 1, 2, ... 9
			$batchID = 0;// change from 0, 1, 2, ... 11 for each function_batch_num

			$functionID = $function_batch_num * 5; 
    ...
    <!-- ****** info to change ****** 
    <input hidden id="functionID" name="functionID" value="0">
	...
	<input hidden id="qualifyTestResult" name="qualifyTestResult" value="0">
