...
<head>
    ...
    <form id="nextCodebtn" method="post" action="5_leaveExp.php" hidden>
        <?php include 'saveRating.php';?>
				...
				<br>
				<br>
				<label class="subtitle">Click the button below to get the code for this task!</label>
				<br>
				<br>
				<br>
        <input class="bluebutton" type="submit" value="Click Here to Get Survey Code">
